                ...
                <div class="card">
                    <div class="card-body">
                        <div class="mb-2 d-flex justify-content-between align-items-center">
                            <div>
                                <h5 class="mb-0 text-capitalize">{{ __('Add Occasion') }}</h5>
                            </div>
                        ...
                        <form action="{{ route('occasion.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                <label for="name">Enter Occasion Name</label>
                                <input type="text" class="form-control" name="name" placeholder="Name of Occasion">
                                @if ($errors->has('name'))
